...
\begin{table}[htbp!]
	...
	\begin{tabular}{@{}lllll@{}}
		...
		$S$ & $F$ & 参数量 & 训练时间 & mIoU \\
		\midrule
		1 & (1) & 1.0$\times$ & 29h & 72.4 \\
		\midrule
		2 & (1,2) & 1.13$\times$ & 34h & 73.5 \\
		2 & (1,3) & 1.13$\times$ & 35h & 73.8 \\
		2 & (1,4) & 1.13$\times$ & 36h & 73.6 \\
		\midrule
		\textbf{3} & \textbf{(1,2,2)} & \textbf{1.20$\times$} & \textbf{40h} & \textbf{75.2} \\
		3 & (1,2,3) & 1.20$\times$ & 41h & 75.3 \\
		3 & (1,2,4) & 1.20$\times$ & 43h & 75.0 \\
		3 & (1,3,3) & 1.20$\times$ & 42h & 74.8 \\
		\midrule
		4 & (1,2,2,2) & 1.27$\times$ & 47h & 75.5 \\
		4 & (1,2,2,3) & 1.27$\times$ & 48h & 75.6 \\
		5 & (1,2,2,2,3) & 1.33$\times$ & 54h & 75.5 \\
		\bottomrule
	\end{tabular}
\end{table}
