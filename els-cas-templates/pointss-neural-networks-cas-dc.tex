...
% Disable ORCID line in CAS front matter.
\makeatletter
...
\begin{abstract}Recently, State Space Models (SSMs) have demonstrated strong global modeling
...
\begin{keywords}Geometry-Aware Feature Learning \sep Multi-Scale Representation \sep Point Cloud Serialization \sep Point Cloud Analysis \sep State Space Models
\end{keywords}
...
\section*{Acknowledgments}                                                    This paper is funded by 20260301004YY.
