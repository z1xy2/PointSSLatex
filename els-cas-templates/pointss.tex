...
\begin{table*}
	\centering
	\caption{Performance Comparison of Semantic Segmentation on S3DIS. $^\dagger$Mean of eight independent runs. One-sample t-tests: $t(7)=2.90$, $p=0.012$ vs. PTv3 (73.4\%); $t(7)=2.14$, $p=0.035$ vs. Pamba (73.5\%). PCM reproduced from official implementation. All other results from original papers.}
	\label{tab:s3dis}
	\begin{tabular}{@{}lll@{}}
		\toprule
		...
		PCM$^\dagger$\cite{pcm} & AAAI'25 & 70.1 \\
