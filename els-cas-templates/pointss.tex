...
\begin{table*}
	\centering
	\caption{Performance Comparison of Semantic Segmentation on S3DIS. $^\dagger$Mean of five independent runs, with standard deviations of $\pm$0.88\% (PCM, reproduced from the official implementation) and $\pm$0.43\% (PointSS). All other results are taken directly from the original papers.}
	\label{tab:s3dis}
	\begin{tabular}{@{}lll@{}}
		\toprule
