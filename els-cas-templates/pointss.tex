...
\begin{table}[t]
\centering
\caption{Efficiency comparison on S3DIS Area 5. Peak memory measured at patch size 512 with batch size 6. Inference time normalized relative to PTv3 baseline.}
\label{tab:efficiency}
\begin{tabular}{lccccc}
\toprule
Method & Params & Peak Mem & Scalability & mIoU & Inference \\
       & (M)    & @512     &             & (\%)  & Time \\
\midrule
PCM    & 34.2   & ---      & ---         & 69.8  & --- \\
PTv3   & 46.2   & 14.7GB   & OOM@1024    & 73.4  & 1.00$\times$ \\
\textbf{PointSS} & \textbf{52.2} & \textbf{6.0GB} & \textbf{stable@2048} & \textbf{73.8} & \textbf{0.81--0.91}$\times$ \\
\bottomrule
\end{tabular}
\end{table}
