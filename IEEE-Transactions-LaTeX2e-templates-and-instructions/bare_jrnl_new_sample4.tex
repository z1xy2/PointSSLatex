...
\end{equation}
where $m = 1, 2, \ldots, \lfloor N/128 \rfloor$ is the window index, and the window size is fixed at 128. If the last window has fewer than $128$ points, it is padded following the strategy of PTv3~\cite{ptv3}.
