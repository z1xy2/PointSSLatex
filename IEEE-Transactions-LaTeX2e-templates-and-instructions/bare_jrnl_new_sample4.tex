...
To suppress unreliable combinations when the two streams disagree, a geometric consistency constraint module computes a scalar gate $\gamma \in [0,1]$ from both streams:
\begin{equation}
