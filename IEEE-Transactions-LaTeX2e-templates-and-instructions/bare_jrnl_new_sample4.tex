...
\end{equation}
where $\Delta q_{ij} = q_j - q_i \in \mathbb{R}^3$ is the relative position vector. $\mathbf{d}_{ij} \in \mathbb{R}^3$ measures the angular deviation between the edge direction and the local surface normal:
\begin{equation}
