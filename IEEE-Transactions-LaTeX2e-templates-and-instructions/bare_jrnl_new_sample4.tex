...
Following PCM \cite{pcm} and PointMamba \cite{PointMamba}, all models are trained from scratch without pre-training, so that performance gains can be attributed to architectural design rather than pre-training strategies.
