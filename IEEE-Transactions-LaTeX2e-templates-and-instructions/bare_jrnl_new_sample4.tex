...
At category boundaries such as those between bookcase and wall (office\_13), baseline methods exhibit blurred or misclassified predictions, whereas PointSS produces sharper and more accurate boundaries. The coarse-grained scales in ASD-SSM maintain long-range memory through slow state decay, facilitating the integration of broader semantic context in transition regions and thereby improving the consistency of boundary predictions.
