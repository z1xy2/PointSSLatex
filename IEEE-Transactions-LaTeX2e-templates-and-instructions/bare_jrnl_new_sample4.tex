...
To further refine the fused features, a geometric consistency module introduces a learnable gating factor $\boldsymbol{\gamma} \in [0,1]$, allowing the model to adaptively calibrate each feature dimension of $\mathbf{H}_{\text{fused}}$:
\begin{align}
