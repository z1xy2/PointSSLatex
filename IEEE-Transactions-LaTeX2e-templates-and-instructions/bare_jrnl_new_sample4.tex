...
context. Experiments demonstrate that PointSS achieves strong
semantic segmentation performance on S3DIS and competitive classification
accuracy on ModelNet40, outperforming major SSM-based counterparts. Compared to Point Transformer V3, PointSS
...
analysis. The main contributions of this work are as follows:
  ...
  \begin{enumerate}
	...
	\item Extensive experiments demonstrate that PointSS achieves 74.1\% mIoU
