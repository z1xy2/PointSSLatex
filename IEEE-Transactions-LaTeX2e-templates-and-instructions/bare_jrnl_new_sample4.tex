...
Notation: $s \in \{1, 2, \ldots, S\}$ denotes the scale index, where $s=1$ represents the finest scale and $s=S$ the coarsest. $N$ and $C$ denote the number of points and the feature dimension, respectively.
