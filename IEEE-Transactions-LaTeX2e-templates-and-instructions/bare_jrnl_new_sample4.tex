...
\end{itemize}
Code will be released at https://github.com/z1xy2/PointSS-public.
...
\begin{table}[!t]
\centering
\caption{Progressive Performance Improvement Path of Modules on S3DIS. + denotes adding modules to Mamba Baseline}
...
Mamba Baseline & 70.3 & - \\
+ GGAM & 72.5 & +2.2 \\
+ GGAM + Shared-param ASD-SSM & 73.4 & +0.9 \\
+ GGAM + Full ASD-SSM (PointSS) & \textbf{75.2} & +1.8 \\
\midrule
