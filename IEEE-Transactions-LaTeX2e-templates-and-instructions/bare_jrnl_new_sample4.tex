...
At category boundaries such as those between bookcase and wall (office\_13), baseline methods exhibit blurred or misclassified predictions, whereas PointSS produces sharper and more accurate boundaries. Through slow state decay, ASD-SSM's coarse-grained scales retain broader contextual information, facilitating the integration of semantic context across transition regions and thereby improving boundary prediction consistency.
