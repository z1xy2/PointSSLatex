...
\end{equation}
A trainable scale embedding $\mathbf{e}_s \in \mathbb{R}^{C/4}$ is maintained for each scale $s$ to encode the identity of each scale.
