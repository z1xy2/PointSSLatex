...
accuracy on ModelNet40, outperforming all SSM-based counterparts. Compared to Transformer-based counterparts, PointSS
achieves faster inference and remains operational at large patch sizes where
